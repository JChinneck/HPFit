...
for folname in folnames:
    ...
    for fname in glob.glob(loc+"/"+experiment+"/"+folname+"/*.csv"):
        ...
        try:
            ...
            if formulation=="mio-bm":
                results[dataset]["alg3-mio-bm runtime"]=float(line1[8])
                results[dataset]["alg3-mio-bm status"]=line1[9]
                results[dataset]["alg3-mio-bm bestbound"]=float(line1[11])
                results[dataset]["alg3-mio-bm gamma"]=float(line1[10])
                results[dataset]["alg3-mio-bm tse"]=float(line1[13])
                results[dataset]["alg3-mio-bm tsestar"]=float(line1[14])
    ...
    results_df = results_df[["i","m","n","m_normal","q",
                             ...
                             "alg3-mio1 gamma", "alg3-mio2 gamma", "alg3-mio3 gamma", "alg3-mio1 tsestar", "alg3-mio2 tsestar", "alg3-mio3 tsestar",
