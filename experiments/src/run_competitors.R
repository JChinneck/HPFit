...
#  - mh: M-estimator 
#  - mm: MM-estimator
#  - rewlse: reweighted least-squares estimator
#
...
# - fit_mh: fit a M-estimator regression model with the j^th column as the
#           response
#     - inputs: 
#        - j: response column
#        - X: data frame
...
#        - q: percentile for least quantile of squares regression
#     - outputs:
#        - mh_dist: sum of squared orthogonal residuals
#        - mh_norm: normal vector to fitted hyperplane
#        - mh_intercept: intercept for fitted hyperplane
#        - mh_rq: the q^th squared residual, measured orthogonally
#        - mh_lts: the sum of squares of the m smallest residuals, measured orthogonally
# - fit_mm: fit a MM-estimator regression model with the j^th column as the
#           response
#     - inputs: 
#        - j: response column
#        - X: data frame
...
#        - q: percentile for least quantile of squares regression
#     - outputs:
#        - mm_dist: sum of squared orthogonal residuals
#        - mm_norm: normal vector to fitted hyperplane
#        - mm_intercept: intercept for fitted hyperplane
#        - mm_rq: the q^th squared residual, measured orthogonally
#        - mm_lts: the sum of squares of the m smallest residuals, measured orthogonally
# - fit_rewlse: fit a MM-estimator regression model with the j^th column as the
#           response
#     - inputs: 
#        - j: response column
#        - X: data frame
...
#        - q: percentile for least quantile of squares regression
#     - outputs:
#        - rewlse_dist: sum of squared orthogonal residuals
#        - rewlse_norm: normal vector to fitted hyperplane
...
#                folder
# - no_hbreg: run CB, and algorithm 3 on a dataset
#     - inputs: 
#        - dataloc: folder containing the data file
#        - srcloc: folder containing implementation of Algorithm 3
#        - fname: data file name
...
#     - outputs: results are written to various files in resloc 
#                folder
# - get_mh: run M-estimator on a dataset
#     - inputs: 
#        - dataloc: folder containing the data file
#        - srcloc: folder containing implementation of Algorithm 3
#        - fname: data file name
...
#        - dep_var: whether there is a dependent variable or not
#        - resloc: folder for results
#     - outputs: results are written to a file in resloc 
#                folder
# - get_mm: run MM-estimator on a dataset
#     - inputs: 
#        - dataloc: folder containing the data file
#        - srcloc: folder containing implementation of Algorithm 3
#        - fname: data file name
...
#     - outputs: results are written to a file in resloc 
#                folder
# - get_rewlse: run MM-estimator on a dataset
#     - inputs: 
#        - dataloc: folder containing the data file
#        - srcloc: folder containing implementation of Algorithm 3
#        - fname: data file name
...
get_dists <- function(dataloc, srcloc, fname, q, dep_var, timelimit, resloc, mosekloc) {
  ...
  if (dep_var == TRUE) {
      ...
      #    arob_time <- c(sum(arob_times[1,]),sum(arob_times[2,]),sum(arob_times[3,]))
      ...
      #    print("bb_times")
      #    print(bb_times)
      #    bb_time <- c(sum(bb_times[1,]),sum(bb_times[2,]),sum(bb_times[3,]))
      #    print(bb_time)
...
get_lm <- function(dataloc, srcloc, fname, q, dep_var, timelimit, resloc) {
  #loc <- 'vary_everything'
  #fname <- 'm102n47m_outliers5num_clust1same_sideFALSEoutlier_dist1000i848.csv'
  #fname <- "m650n10m_outliers350i0.csv"
  #loc <- 'rd'
...
get_lts <- function(dataloc, srcloc, fname, q, dep_var, timelimit, resloc) {
  #loc <- 'vary_everything'
  #fname <- 'm102n47m_outliers5num_clust1same_sideFALSEoutlier_dist1000i848.csv'
  #fname <- "m650n10m_outliers350i0.csv"
  #loc <- 'rd'
...
get_lqs <- function(dataloc, srcloc, fname, q, dep_var, timelimit, resloc) {
  #loc <- 'vary_everything'
  #fname <- 'm102n47m_outliers5num_clust1same_sideFALSEoutlier_dist1000i848.csv'
  #fname <- "m650n10m_outliers350i0.csv"
  #loc <- 'rd'
...
get_cb_alg3 <- function(dataloc, srcloc, fname, q, dep_var, timelimit, resloc, mosekloc) {
  #loc <- 'vary_everything'
  #fname <- 'm102n47m_outliers5num_clust1same_sideFALSEoutlier_dist1000i848.csv'
  #fname <- "m650n10m_outliers350i0.csv"
  #loc <- 'rd'
...
get_cb <- function(dataloc, srcloc, fname, q, dep_var, timelimit, resloc, mosekloc) {
  #loc <- 'vary_everything'
  #fname <- 'm102n47m_outliers5num_clust1same_sideFALSEoutlier_dist1000i848.csv'
  #fname <- "m650n10m_outliers350i0.csv"
  #loc <- 'rd'
...
## -----------------------------------------------------------------------------------------------------
hbreg_only <- function(dataloc, srcloc, fname, q, dep_var, timelimit, resloc, mosekloc) {
  #loc <- 'vary_everything'
  #fname <- 'm102n47m_outliers5num_clust1same_sideFALSEoutlier_dist1000i848.csv'
  #fname <- "m650n10m_outliers350i0.csv"
  #loc <- 'rd'
